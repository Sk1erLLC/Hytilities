...
import club.sk1er.hytilities.handlers.chat.modules.blockers.BedwarsAdvertisementsCleaner;
import club.sk1er.hytilities.handlers.chat.modules.blockers.ConnectedMessage;
import club.sk1er.hytilities.handlers.chat.modules.blockers.ConnectionStatusCleaner;
import club.sk1er.hytilities.handlers.chat.modules.blockers.CurseOfSpamBlocker;
import club.sk1er.hytilities.handlers.chat.modules.blockers.GameAnnoucementCleaner;
...
import club.sk1er.hytilities.handlers.chat.modules.blockers.HypeLimitCleaner;
import club.sk1er.hytilities.handlers.chat.modules.blockers.JoinMessagesTypesCleaner;
import club.sk1er.hytilities.handlers.chat.modules.blockers.LineBreakerTrim;
import club.sk1er.hytilities.handlers.chat.modules.blockers.MvpEmotesBlocker;
import club.sk1er.hytilities.handlers.chat.modules.blockers.MysteryBoxAnnouncer;
...
import club.sk1er.hytilities.handlers.chat.modules.blockers.SoulWellAnnouncerCleaner;
...
public class ChatHandler {
    ...
    public ChatHandler() {
        ...
        this.registerModule(new BedwarsAdvertisementsCleaner());
        this.registerModule(new ConnectionStatusCleaner());
        this.registerModule(new CurseOfSpamBlocker());
        this.registerModule(new GameAnnoucementCleaner());
        this.registerModule(new HypeLimitCleaner());
        this.registerModule(new JoinMessagesTypesCleaner());
        this.registerModule(new LineBreakerTrim());
        this.registerModule(new MvpEmotesBlocker());
        this.registerModule(new MysteryBoxAnnouncer());
        this.registerModule(new SoulWellAnnouncerCleaner());
