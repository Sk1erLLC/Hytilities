...
public class HypeLimitCleaner implements ChatReceiveModule {
    ...
    public void onMessageReceived(@NotNull ClientChatReceivedEvent event) {
        ...
        if (message.startsWith(language.chatCleanerHypeLimit)) {
    ...
    public boolean isEnabled() {
        return HytilitiesConfig.hypeLimitReminder;
    }
}
