...
public class ConnectionStatusCleaner implements ChatReceiveModule {
    @Override
    ...
    public void onMessageReceived(@NotNull ClientChatReceivedEvent event) {
        ...
        if (language.chatCleanerConnectionStatusRegex.matcher(message).matches()) {
    ...
    public boolean isEnabled() {
        return HytilitiesConfig.connectionStatus;
    }
}
